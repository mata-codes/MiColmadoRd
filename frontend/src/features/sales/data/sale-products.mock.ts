...
export const SALE_PRODUCTS: SaleProduct[] = [
  ...
  { id: 4, name: "Cerveza Presidente pequeña", price: 55, category: "Bebidas" },
  { id: 5, name: "Pan de Molde", price: 60, category: "Panadería" },
  { id: 6, name: "Pan Sobao", price: 25, category: "Panadería" },
  { id: 7, name: "Bizcocho", price: 40, category: "Panadería" },
  { id: 8, name: "Leche Entera 1L", price: 55, category: "Lácteos" },
  { id: 9, name: "Queso Blanco", price: 80, category: "Lácteos" },
  { id: 10, name: "Yogurt Natural", price: 50, category: "Lácteos" },
  ...
  { id: 16, name: "Jabón Líquido", price: 55, category: "Limpieza" },
